...
|---|---|
| Assets | Ownership, assignment, warranty, lifecycle, disposal |
| Helpdesk | Priority, SLA, aging, escalation, root cause |
| Access | Joiner/Mover/Leaver controls, privilege, approvals |
| Vendors | Contracts, renewals, SLA, performance, spend |
...
- [x] IT asset toolkit
- [x] Helpdesk / SLA toolkit
- [x] Access lifecycle toolkit
- [x] Vendor management
...
IT Management · Infrastructure · ERP/Odoo · Digital Transformation · Cybersecurity · AI & Automation
